...
use App\Http\Controllers\PackageBanksController;
use App\Http\Controllers\PackageBookingsController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function() {
        ...
        Route::middleware('can:manage transactions')->group(function(){
            Route::resource('package_bookings', PackageBookingsController::class);
        });

        Route::middleware('can:manage package banks')->group(function(){
            Route::resource('package_banks', PackageBanksController::class);
        });
    });
});
