...
class PackageBanksController extends Controller
{
    /**
    ...
    {
        $packageBanks = PackageBank::orderByDesc('id')->paginate(10);
     ...
     */
    public function show(PackageBank $packageBanks)
    {
        //
    }
     ...
     */
    public function update(UpdatePackageBankRequest $request, PackageBank $packageBanks)
    {
